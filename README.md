# @emiplegiaqmnpm/eaque-vitae-recusandae

> forked from [@emiplegiaqmnpm/eaque-vitae-recusandaeode](https://www.npmjs.com/package/@emiplegiaqmnpm/eaque-vitae-recusandaeode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@emiplegiaqmnpm/eaque-vitae-recusandaeode/issues/300).

[![npm version](https://img.shields.io/npm/v/@emiplegiaqmnpm/eaque-vitae-recusandae.svg)](https://www.npmjs.com/package/@emiplegiaqmnpm/eaque-vitae-recusandae)
[![Downloads](https://img.shields.io/npm/dm/@emiplegiaqmnpm/eaque-vitae-recusandae.svg)](https://www.npmjs.com/package/@emiplegiaqmnpm/eaque-vitae-recusandae)
[![Build Status](https://github.com/emiplegiaqmnpm/eaque-vitae-recusandae/workflows/CI/badge.svg)](https://github.com/emiplegiaqmnpm/eaque-vitae-recusandae/actions)
...
```sh
npm install --save-dev eslint @emiplegiaqmnpm/eaque-vitae-recusandae
```
...
```js
const nodePlugin = require("@emiplegiaqmnpm/eaque-vitae-recusandae")
...
💼 [Configurations](https://github.com/emiplegiaqmnpm/eaque-vitae-recusandae#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/emiplegiaqmnpm/eaque-vitae-recusandae#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/emiplegiaqmnpm/eaque-vitae-recusandae#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/emiplegiaqmnpm/eaque-vitae-recusandae#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/emiplegiaqmnpm/eaque-vitae-recusandae#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/emiplegiaqmnpm/eaque-vitae-recusandae#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/emiplegiaqmnpm/eaque-vitae-recusandae#-configs).\
...
`@emiplegiaqmnpm/eaque-vitae-recusandae` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/emiplegiaqmnpm/eaque-vitae-recusandae/releases)
